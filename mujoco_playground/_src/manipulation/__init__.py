...
from mujoco_playground._src.manipulation.doosan_robotics import pick as dsr_pick
from mujoco_playground._src.manipulation.doosan_robotics import pick_avoid as dsr_pick_avoid
...
_envs = {
    ...
    "DSRPickCube": dsr_pick.PandaPickCube,
    "_DSRPickCubeAvoiding": dsr_pick_avoid.DSRPickCubeAvoiding,
}
...
_cfgs = {
    ...
    "DSRPickCube": dsr_pick.default_config,
    "_DSRPickCubeAvoiding": dsr_pick_avoid.default_config,
}
